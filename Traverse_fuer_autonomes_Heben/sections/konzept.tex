...
Falls mehrere Marker erkannt werden, wird der Mittelwert aller neuen Punkten genommen.
...
Dabei wird die Markerlänge l, welches hier ein Vektor ist, mit der Rotation R multipliziert. Mit dem rotierten Vektor kann nun in die Mitte translatiert werden.  
